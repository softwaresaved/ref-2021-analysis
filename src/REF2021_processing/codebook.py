...
# suffix added to column name to indicate the column has been added by the processing
COLUMN_NAME_ADDED_SUFFIX = " (added)"

# suffix added to column name to indicate the column has beed added with binned values
COLUMN_NAME_BINNED_SUFFIX = " (binned)"
...
# about the research income in kind
COL_INCOME_IN_KIND_SOURCE = "Income source"
...
COL_DEGREES_TOTAL = f"Total number of doctoral degrees awarded {COLUMN_NAME_ADDED_SUFFIX}"
# about the output
...
COL_RESULTS_TOTAL_FTE_SUBMITTED_JOINT = (
    "Total FTE of submitted staff for joint submission"
)
COL_RESULTS_PERC_STAFF_SUBMITTED_BINNED = (
    f"{COL_RESULTS_PERC_STAFF_SUBMITTED}{COLUMN_NAME_BINNED_SUFFIX}"
)
...
COL_RESULTS_4star_BINNED = f"{COL_RESULTS_4STAR}{COLUMN_NAME_BINNED_SUFFIX}"
COL_RESULTS_3star_BINNED = f"{COL_RESULTS_3STAR}{COLUMN_NAME_BINNED_SUFFIX}"
COL_RESULTS_2star_BINNED = f"{COL_RESULTS_2STAR}{COLUMN_NAME_BINNED_SUFFIX}"
COL_RESULTS_1star_BINNED = f"{COL_RESULTS_1STAR}{COLUMN_NAME_BINNED_SUFFIX}"
COL_RESULTS_UNCLASSIFIED_BINNED = (
    f"{COL_RESULTS_UNCLASSIFIED}{COLUMN_NAME_BINNED_SUFFIX}"
)

# columns to drop when processing the sheet data
COLUMNS_TO_DROP = [
    COL_INST_CODE,
    COL_INST_CODE_BRACKETS,
    COL_RESULTS_SORT_ORDER,
    COL_PANEL_CODE,
    COL_UOA_NUMBER,
    COL_OUTPUT_TYPE_CODE,
    COL_IMPACT_ORCID,
    COL_IMPACT_GRANT_FUNDING,
    COL_IMPACT_REFERENCES_RESEARCH,
    COL_IMPACT_CORROBORATE,
    COL_IMPACT_IS_CONTINUED,
    COL_IMPACT_COUNTRIES,
    COL_IMPACT_FORMAL_PARTNERS,
    COL_IMPACT_GLOBAL_ID,
    COL_IMPACT_UNDERPIN_RESEARCH,
]

# columns to make categorical when processing the sheet data
COLUMNS_TO_CATEGORY = [
    COL_INST_NAME,
    COL_PANEL_NAME,
    COL_UOA_NAME,
    ...
    COL_OUTPUT_RESEARCH_GROUP,
    COL_OPEN_ACCESS,
    COL_OUTPUT_CITATIONS,
    COL_OUTPUT_CROSS_REFERRAL,
    COL_OUTPUT_INTERDISCIPLINARY,
    COL_OUTPUT_NON_ENGLISH,
    COL_OUTPUT_FORENSIC_SCIENCE,
    COL_OUTPUT_CRIMINOLOGY,
    COL_OUTPUT_DOUBLE_WEIGHTING,
    COL_OUTPUT_RESERVE_OUTPUT,
    COL_OUTPUT_DELAYED,
    COL_IMPACT_IS_CONTINUED,
]
